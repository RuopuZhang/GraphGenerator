...
def plot_range_to_csv(df, output_csv, start_row=9, end_row=13,start_col=13, end_col=18):
...
def tabular_range_to_csv(df, output_csv, start_row=9, end_row=13, start_col=5, end_col=12):
...
def title_range_to_csv(df, output_csv, start_row=86, end_row=86, start_col=14, end_col=20):
    """ Extract data from given range specified by start/end rows and
    columns.
